class MovieRentingSystem {
  ...
  public record Entry(int price, int shop, int movie) {}

  public Comparator<Entry> comparator = (a, b) -> {
    if (a.price != b.price)
  ...
  public Map<Integer, Set<Entry>> unrented = new HashMap<>();
  public Map<Pair<Integer, Integer>, Integer> shopAndMovieToPrice = new HashMap<>();
  public Set<Entry> rented = new TreeSet<>(comparator);
}